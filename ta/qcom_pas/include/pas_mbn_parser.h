 ...
 *   [ ehsize + phentsize * phnum bytes ]  ELF header + program-header table
 *   [ hash-segment bytes                ]  verbatim MBN hash-segment content
 *
 * The MBN hash segment holds signing material:
 *
 *   v5 (40-byte header):
